...
-- CreateTable
CREATE TABLE "team_color_master" (
    "id" SERIAL NOT NULL,
    "country" TEXT NOT NULL,
    "league" TEXT NOT NULL,
    "team" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "team_member_master_team_jersey_member_face_pic_path_key" ON "team_member_master"("team", "jersey", "member", "face_pic_path");
